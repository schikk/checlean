...
@Component({
  selector: 'app-finished-cases',
  templateUrl: './finished-cases.component.html',
  styleUrls: ['./finished-cases.component.scss']
})
export class FinishedCasesComponent implements OnInit {
